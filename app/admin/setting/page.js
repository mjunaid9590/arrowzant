    ...
    <div>
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-10 mx-auto">
          ...
          <div>
            <div className="flex flex-col p-5 md:flex-wrap md:justify-evenly -m-2 bg-indigo-200 py-10 rounded-2xl ">
              <div className="p-2">
              ...
              <button className='text-center mt-3 mx-auto px-3 my-auto text-lg p-2 px-5 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white'>Save</button>
            </div>
