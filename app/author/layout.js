                    ...
                    <div className="h-full px-3 py-4 overflow-y-auto  ">
                        <ul className="space-y-2 font-medium">
                            <li className="border-b-2">
                                <Link href="/author" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group">
                                    
                                    <span className="ml-3">Dashboard</span>
                                </Link>
                            </li>
                            <li className="border-b-2">
                                <Link href="/author/novels" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group">
                                  
                                    <span className="flex-1 ml-3 whitespace-nowrap">My Novels</span>
                                </Link>
                            </li>
                            <li className="border-b-2">
                                <Link href="/author/writing-desk" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group">
                                  
                                    <span className="flex-1 ml-3 whitespace-nowrap">Writing Desk</span>
                                </Link>
                            </li>
                            <li className="border-b-2">
                                <Link href="/author/setting" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group">
