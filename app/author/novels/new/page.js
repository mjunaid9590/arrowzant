                ...
                <div className="container px-5 py-10 mx-auto">
                    ...
                    <div>
                        <div className="flex flex-col justify-evenly -m-2 bg-indigo-200 py-5 rounded-2xl">
                            ...
                            <div className="p-2 w-3/4 mx-auto">
                                <div className="flex flex-col">
                                    <label htmlFor="genre" className="leading-7 my-auto py-2 text-2xl text-gray-600">
                                        Genre / Category:
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <Link href='#' className='mx-auto text-lg p-2 mt-4 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white'> Proceed <ArrowForwardIosIcon /> </Link>
