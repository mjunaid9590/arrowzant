...
const AuthorSetting = () => {
  return (
    <div>
      ...
      <h1 className='text-3xl p-5 text-center text-black'>Settings</h1>
        <div className="container px-5 py-5 mx-auto ">
          ...
          <div className='flex flex-col h-full md:flex-row md:space-x-5 '>
            <div className="flex flex-col p-5 h-full md:mt-4 md:flex-wrap md:w-1/2 md:justify-evenly -m-2 bg-indigo-200 py-10 rounded-2xl ">
              <div className="p-2">
            ...
            <div className="flex flex-col p-5 h-full mt-4 md:flex-wrap md:w-1/2 md:justify-evenly -m-2 bg-indigo-200 py-10 rounded-2xl ">
              <div className="p-2">
                <div className="flex flex-col">
