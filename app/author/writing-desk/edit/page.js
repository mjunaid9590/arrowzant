...
const EditChapter = () => {
    ...
    return (
        <div>
            <section className="text-gray-600 dark:text-gray-100 body-font relative">
                <div className="container px-5 py-10 mx-auto">
                    <div className="flex flex-col w-full mb-8">
                        ...
                        <h2 className="sm:text-2xl text-xl font-medium title-font mb-2 text-gray-900 dark:text-indigo-100">
                            Chapter No: <strong>112</strong>
                        </h2>
                    </div>
                    <div>
                        <div className="flex flex-col justify-evenly -m-2 bg-indigo-200 dark:bg-gray-900 py-5 px-4 rounded-2xl">


                            <div className="p-2">
                                <div className="flex flex-col">
                                    <label htmlFor="name" className="my-auto py-2 text-2xl leading-7">
                                        Chapter Title
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div className='flex space-x-5 md:justify-end md:mr-10'>
