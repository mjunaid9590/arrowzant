  ...
  return (
    <div className='category-heading-container mb-4'>
      <div className='flex flex-row md:ml-4'>
        ...
        <Link href={`/${props.categorySlug}`} className='my-auto ml-auto md:mr-10 rounded-md text-lg text-indigo-800 dark:text-indigo-300 hover:bg-slate-400 hover:text-gray-900  p-2'>Show More {`>>`}</Link>
      </div>
