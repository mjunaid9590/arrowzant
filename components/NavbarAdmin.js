            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                </div>
                {
                    <div className={`items-center justify-between ${((isDropdownOpen) || (isSearchOpen)) ? '' : 'hidden'} w-full md:flex md:w-auto md:order-1" id="navbar-search`}>
                        ...
                        <ul className={`flex flex-col text-center p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 ${!isDropdownOpen ? 'hidden md:flex md:flex-row' : ''}`}>
                            <li className=' my-auto'>
                                <Link href="/admin" className={`flex text-center items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group ${isActiveClass('/admin')}`}>
