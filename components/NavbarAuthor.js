                    ...
                    <div className={`items-center justify-between ${((isDropdownOpen) || (isSearchOpen)) ? '' : 'hidden'} w-full md:flex md:w-auto md:order-1" id="navbar-search`}>
                        ...
                        <ul className={`flex flex-col text-center p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-md bg-gray-50 md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 ${!isDropdownOpen ? 'hidden md:flex md:flex-row' : ''}`}>
                            <li className='my-auto px-1 border-r border-gray-300'>
                                <Link href="/author" onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex text-center items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group ${isActiveClass('/author')}`}>
                                    <span className="">Dashboard</span>
                                </Link>
                            </li>
                            <li className='my-auto md:px-1 md:border-r md:border-gray-300'>
                                <Link href="/author/novels" onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group ${isActiveClass('/author/novels')}`}>
                                    <span className="">My Novels</span>
                                </Link>
                            </li>
                            <li className='my-auto md:px-1 md:border-r md:border-gray-300'>
                                <Link href="/author/writing-desk"  onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-indigo-200 dark:bg-gray-700 group ${isActiveClass('/author/writing-desk')}`}>
                                    <span className="">Writing Desk</span>
                                </Link>
                            </li>
                            <li className='my-auto md:px-1 '>
                                <Link href="/author/setting" onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-indigo-200 dark:hover-bg-gray-700 group ${isActiveClass('/author/setting')}`}>
...
//     console.log("Running bhai running")
//     return (
//         <nav className="bg-white dark:text-indigo-100 border-gray-200 dark:bg-gray-900 shadow-xl overflow-visible">
//             <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
//                 <Link href="/" className="flex items-center">
//                     <img
//                         src="/logo512.png"
...
//                                 <Link href="/author" onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover-bg-gray-700 group ${isActive('/author') ? 'bg-indigo-300 dark:bg-indigo-900' : ''}`}>
//                                     <span className="ml-3">Dashboard</span>
//                                 </Link>
//                             </li>
//                             <li>
//                                 <Link href="/author/novels" onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group ${isActive('/author/novels') ? 'bg-indigo-300 dark:bg-indigo-900' : ''}`}>
//                                     <span className="flex-1 ml-3 whitespace-nowrap">My Novels</span>
//                                 </Link>
//                             </li>
//                             <li className=' my-auto'>
//                                 <Link href="/author/writing-desk" onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover:bg-gray-700 group ${isActive('/author/writing-desk') ? 'bg-indigo-300 dark:bg-indigo-900' : ''}`}>
//                                     <span className="flex-1 ml-3 whitespace-nowrap">Writing Desk</span>
//                                 </Link>
//                             </li>
//                             <li className=' my-auto'>
//                                 <Link href="/author/setting" onClick={()=>{setDropdownOpen(!isDropdownOpen)}} className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-indigo-200 dark:hover-bg-gray-700 group ${isActive('/author/setting') ? 'bg-indigo-300 dark:bg-indigo-900' : ''}`}>
